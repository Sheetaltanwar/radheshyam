...
const TopUniversity = () => {
  ...
  return (
    <div>
       ...
       <div style={{width:'200px',margin:'33px'}}> <h2 style={{textAlign:'center' ,color:'white'}}>Universities</h2></div>
      <div style={{width:'500px',marginRight:'67px'}}>  <h2 style={{textAlign:'right',fontWeight:'200',color:'white'}}>Top Universities In India</h2></div>
    </div>
